...
function PLAY() {
    ...
    if (player1Choice === 'paper') {
        displayplayer1Choice.src = "./IMAGE/paper.png"
    } else if (player1Choice === 'rock') {
        displayplayer1Choice.src = "./IMAGE/rock.png"
    } else {
        displayplayer1Choice.src = "./IMAGE/scissor.png"
    }

    if (player2Choice === "paper") {
        displayplayer2Choice.src = "./IMAGE/paper.png"
    } else if (player2Choice === "rock") {
        displayplayer2Choice.src = "./IMAGE/rock.png"
    } else {
        displayplayer2Choice.src = "./IMAGE/scissor.png"
    }
